...
public class ARPlacementAndDetection : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        informUIPanelText.text = "Movephone to detect planes and place the Battle Arena.";
    }
    ...
    public void DisableARPlacementAndDetection()
    {
        ...
        informUIPanelText.text = "Arena READY. Now search for games and BATTLE.";
    }
